...
<%-- 														data-boardno="${r.refBno}" --%>
<%-- 														data-reportno="${r.reportNo}" --%>
<!-- 														>글상세</button></td> -->
												<td><button type="button"
														class="btn btn-primary reportdelete"
														data-boardno="${r.reportNo}" onclick="confirmation(${r.reportNo})">확인</button></td>
	...
	<script>
						...
						function viewNoticeDetail(clickedBoardNo, clickedReportNo) {
						    ...
						    $.ajax({
						        url: "adminReportReviewDetail?refBno=" + clickedBoardNo,
						        dataType: "json",
						        success: function (result) {
						            if (result && result.board) {
						                ...
						                $("#NoticeBoardNo").text(board.reviewNo);						                
						                $("#NoticeBoardTitle").text(board.reviewTitle);
						                $("#NoticeBoardContent").html(board.reviewContent);
						                ...
						                document.querySelector("#deleteBtn").onclick = function () {
						                	 const deleteCheck = confirm("정말로 삭제 하시겠습니까?");
							                    ...
							                    if (deleteCheck) {
							                        deleteBoardReport(board.reviewNo, clickedReportNo);
