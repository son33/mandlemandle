...
/**
 * Servlet implementation class adminReplyDelete
 */
@WebServlet("/adminReplyDelete")
public class adminReplyDeleteController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminReplyDeleteController() {
        super();
    }
