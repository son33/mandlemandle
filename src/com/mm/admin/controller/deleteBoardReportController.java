...
/**
 * Servlet implementation class deleteBoardReportController
 */
@WebServlet("/deleteBoardReport")
public class deleteBoardReportController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public deleteBoardReportController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result2 = service.deleteBoardReport(refBno);
