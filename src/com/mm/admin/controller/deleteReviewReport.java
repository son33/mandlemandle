...
/**
 * Servlet implementation class deleteReviewReport
 */
@WebServlet("/deleteReviewReport")
public class deleteReviewReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public deleteReviewReport() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result2 = service.deleteReviewReport(refBno);
