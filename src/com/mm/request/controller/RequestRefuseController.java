...
/**
 * Servlet implementation class RequestRefuseController
 */
@WebServlet("/request.rf")
public class RequestRefuseController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RequestRefuseController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = service.refuseRequest(requestNo);
		if(result > 0) {
			request.setAttribute("alertMsg", "거절하였습니다");
			new Request();
			...
			request.setAttribute("alertMsg", "거절에 실패했습니다. 다시 시도해주세요.");
		}
